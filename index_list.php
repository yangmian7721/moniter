                    ...
                    <div class="row">
                        <div class="col-xs-4" style="margin-top: 15px;margin-bottom: 15px;">
                          <svg class="icon" aria-hidden="true">
                            <use xlink:href="#icon-houdongfangiconfont01"></use>
                          </svg>
                        </div>
                        <div class="col-xs-8">
                            <h4 class="subtitle color-lighter-1">当前上网人数</h4>
                            <h1 class="title color-light"> 1124</h1>
                        </div>
                    </div>
                </div>
        </div>
                ...
                <div class="panel-content">
                    <div class="row">
                      <div class="col-xs-4" style="margin-top: 15px;margin-bottom: 15px;">
                        ...
                        <div class="col-xs-8">
                            <h4 class="subtitle color-lighter-1">当前连接数</h4>
          ...
          <div class="panel">
                <div class="panel-content">
                    <div class="row">
                      <div class="col-xs-4" style="margin-top: 15px;margin-bottom: 15px;">
                        <svg class="icon" aria-hidden="true">
                          <use xlink:href="#icon-liuliang1"></use>
                        </svg>
                      </div>
                        <div class="col-xs-8">
                            <h4 class="subtitle color-lighter-1">当前连接数</h4>
...
function size_auto() {
  ...
  lists.setAttribute('height',(2*downlist_h));
  td_temp.setAttribute('height',(height-4*downlist_h)/2);
  td_in.setAttribute('height',(height-4*downlist_h)/2);
  td_out.setAttribute('height',(height-4*downlist_h)/2);
  td_sta.setAttribute('height',(height-4*downlist_h)/2);
